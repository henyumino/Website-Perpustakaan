var usersLogin = angular.module('usersLoginApp', ['chieffancypants.loadingBar', 'ngAnimate'])
.config(function(cfpLoadingBarProvider) {
    cfpLoadingBarProvider.includeSpinner = false;
  })

 usersLogin.controller('usersLoginController', function($scope, $http, $timeout, cfpLoadingBar) {
    ...
    $scope.usrLogin = function() {
     ...
     .then((confirm) => {
     	if (confirm) {
            ...
            $http({
               method: "post",
               url: "http://localhost:8080/projekuas/ajax/users_login.php",
               data: {
                       email    : $scope.email,
