var usersBookCategory = angular.module('usersBookCategoryApp', ['chieffancypants.loadingBar', 'ngAnimate'])
.config(function(cfpLoadingBarProvider, $compileProvider) {
    cfpLoadingBarProvider.includeSpinner = false;
    $compileProvider.aHrefSanitizationWhitelist(/^\s*(https?|ftp|mailto|file|javascript):/);
  })

 usersBookCategory.controller('usersBookCategoryController', function($scope, $http, $timeout, cfpLoadingBar) {
