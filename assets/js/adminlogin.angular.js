var adminLogin = angular.module('adminLoginApp', ['chieffancypants.loadingBar', 'ngAnimate'])
.config(function(cfpLoadingBarProvider) {
    cfpLoadingBarProvider.includeSpinner = false;
  })

 adminLogin.controller('adminLoginController', function($scope, $http, $timeout, cfpLoadingBar) {
    ...
    $scope.admLogin = function() {
     ...
     .then((confirm) => {
     	if (confirm) {
            ...
            $http({
               method: "post",
               url: "http://localhost:8080/projekuas/ajax/admin_login.php",
               data: {
                       email    : $scope.email,
