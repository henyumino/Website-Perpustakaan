<body ng-app="adminLoginApp" ng-controller="adminLoginController">
  <div class="wrapper">
  	<div class="form-input">
  	  <div class="form">
  	  	<h2 style="text-align:center; padding-top:100px; color:#000;">Login Admin</h2>
		   <form method="POST" name="adminLoginform">
			  <input type="text" class="input_sekretaris" placeholder="Email" name="email" ng-model="email" ng-minlength="15" ng-maxlength="50" ng-pattern="/^([a-z0-9\+_\-]+)(\.[a-z0-9\+_\-]+)*@([a-z0-9\-]+\.)+[a-z]{2,6}$/" required><br/>
				<div ng-show="adminLoginform.email.$touched && adminLoginform.email.$error.required">
 				...
 				<div ng-show="adminLoginform.email.$error.minlength">
 				...
 				<div ng-show="adminLoginform.email.$error.maxlength">
 				...
 				<div ng-show="adminLoginform.email.$error.pattern">
			...
			<input type="password" name="password" class="input_sekretaris" placeholder="Password" ng-model="password" ng-minlength="5" ng-maxlength="25" ng-pattern="/^[a-zA-Z-0-9]*$/" required><br/>
				<div ng-show="adminLoginform.password.$touched && adminLoginform.password.$error.required">
 				...
 				<div ng-show="adminLoginform.password.$error.minlength">
 				...
 				<div ng-show="adminLoginform.password.$error.maxlength">
 				...
 				<div ng-show="adminLoginform.password.$error.pattern">
			...
			<div ng-if="adminLoginform.$valid">
 				<button type="submit" class="submit" ng-click="admLogin()">Masuk</button>
 			</div>
 			<div ng-if="!adminLoginform.$valid">
