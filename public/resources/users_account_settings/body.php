<body ng-app="usersAccountSettingsApp" ng-controller="usersAccountSettingsController">
  <div class="menu-atas">
  ...
  <label>Profil</label>
    <hr class="garis-dash">
        <div class="box-input-set">
           <ng-form method="POST" name="usersEditAccountForm">
                ...
                <div ng-show="usersEditAccountForm.fullname.$touched && usersEditAccountForm.fullname.$error.required">
                ...
                <div ng-show="usersEditAccountForm.fullname.$error.minlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Nama lengkap minimal 3 karakter
                  </font>
                </div>
                <div ng-show="usersEditAccountForm.fullname.$error.maxlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Nama lengkap maksimal 25 karakter
                  </font>
               </div>
               <div ng-show="usersEditAccountForm.fullname.$error.pattern">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
               ...
               <select name="dateofbirth" data-ng-model="dateofbirth" required style="margin: 10px 30px 0;width:310px;height:35px;border-radius:5px;border: 1px solid grey;">
                ...
                <div ng-show="usersEditAccountForm.dateofbirth.$touched && usersEditAccountForm.dateofbirth.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
               ...
               <select name="monthofbirth" data-ng-model="monthofbirth" required style="margin: 10px 46px 0;width:310px;height:35px;border-radius:5px;border: 1px solid grey;">
                ...
                <div ng-show="usersEditAccountForm.monthofbirth.$touched && usersEditAccountForm.monthofbirth.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
               ...
               <select name="yearofbirth" data-ng-model="yearofbirth" required style="margin: 10px 58px 0;width:310px;height:35px;border-radius:5px;border: 1px solid grey;">
                ...
                <div ng-show="usersEditAccountForm.yearofbirth.$touched && usersEditAccountForm.yearofbirth.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                ...
                <div ng-show="usersEditAccountForm.address.$touched && usersEditAccountForm.address.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                      Alamat masih kosong
                  </font>
                </div>
                <div ng-show="usersEditAccountForm.address.$error.minlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Alamat minimal 10 karakter
                  </font>
                </div>
                <div ng-show="usersEditAccountForm.address.$error.maxlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Alamat maksimal 50 karakter
                  </font>
               </div>
               <div ng-show="usersEditAccountForm.address.$error.pattern">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
               ...
               <span class="label-input">Nomor Ponsel</span>
                ...
                <div ng-show="usersEditAccountForm.phonenumber.$touched && usersEditAccountForm.phonenumber.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                      Nomor ponsel masih kosong
                  </font>
                </div>
                <div ng-show="usersEditAccountForm.phonenumber.$error.minlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Nomor ponsel harus terdiri dari 12 digit
                  </font>
                </div>
                <div ng-show="usersEditAccountForm.phonenumber.$error.maxlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Nomor ponsel harus terdiri dari 12 digit
                  </font>
               </div>
               <div ng-show="usersEditAccountForm.phonenumber.$error.pattern">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
               ...
               <span class="label-input">Email</span>
                ...
                <div ng-show="usersEditAccountForm.email.$touched && usersEditAccountForm.email.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                      Email masih kosong
                  </font>
                </div>
                <div ng-show="usersEditAccountForm.email.$error.minlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Email minimal 15 karakter
                  </font>
                </div>
                <div ng-show="usersEditAccountForm.email.$error.maxlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Email maksimal 50 karakter
                  </font>
               </div>
               <div ng-show="usersEditAccountForm.email.$error.pattern">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
               ...
               <div ng-show="!profilepicture">
                  <img src="<?=$Variable['URL'].'resources/assets/'.$Variable['Data']['Folder_Pengguna'].'/'.$Variable['Data']['Foto_Pengguna'];?>" style="width:180px;height:180px;margin:10px 0px 0px 310px">
              </div>
              <div ng-show="profilepicture">
            ...
            <div ng-show="profilepicture">
              <div class="crop-area-1a">
               ...
               <div ng-if="usersEditAccountForm.$valid">
               <button id="button-save-setting" type="submit" ng-click="usersEditAccount(croppedprofilepicture, profilepicture.name)">Perbaharui</button>
               </div>
               <div ng-if="!usersEditAccountForm.$valid">
          ...
          <div style="margin-top: 30px;">
            ...
            <span class="label-input">Katasandi Lama</span>
             <ng-form method="POST" name="usersChangePasswordForm">
                ...
                <div ng-show="usersChangePasswordForm.password.$touched && usersChangePasswordForm.password.$error.required">
                ...
                <div ng-show="usersChangePasswordForm.password.$error.minlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
                     Katasandi lama minimal 5 karakter
                  </font>
                </div>
                <div ng-show="usersChangePasswordForm.password.$error.maxlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
                     Katasandi lama maksimal 25 karakter
                  </font>
               </div>
               <div ng-show="usersChangePasswordForm.password.$error.pattern">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
               ...
               <input type="password" name="newpassword" ng-model="newpassword" ng-minlength="5" ng-maxlength="25" ng-pattern="/^[a-zA-Z-0-9]*$/" required style="margin: 10px 37px 0;width:295px;padding:8px;border-radius:5px;border: 1px solid grey;">
                <div ng-show="usersChangePasswordForm.newpassword.$touched && usersChangePasswordForm.newpassword.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
                      Katasandi baru masih kosong
                  </font>
                </div>
                <div ng-show="usersChangePasswordForm.newpassword.$error.minlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
                     Katasandi baru minimal 5 karakter
                  </font>
                </div>
                <div ng-show="usersChangePasswordForm.newpassword.$error.maxlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
                     Katasandi baru maksimal 25 karakter
                  </font>
               </div>
               <div ng-show="usersChangePasswordForm.newpassword.$error.pattern">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
                     Katasandi baru hanya boleh berisi huruf dan angka
                  </font>
               </div>
               <div ng-if="usersChangePasswordForm.$valid">
               <button id="button-update-pass" type="submit" ng-click="usersChangePassword()">Ganti Katasandi</button>
               </div>
               <div ng-if="!usersChangePasswordForm.$valid">
