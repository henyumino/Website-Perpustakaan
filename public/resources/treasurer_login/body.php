<body ng-app="treasurerLoginApp" ng-controller="treasurerLoginController">
  <div class="wrapper">
  	<div class="form-input">
  	  <div class="form">
  	  	<h2 style="text-align:center; padding-top:100px; color:#000;">Login Bendahara</h2>
		   <form method="POST" name="treasurerLoginform">
			  <input type="text" class="input_sekretaris" placeholder="Email" name="email" ng-model="email" ng-minlength="15" ng-maxlength="50" ng-pattern="/^([a-z0-9\+_\-]+)(\.[a-z0-9\+_\-]+)*@([a-z0-9\-]+\.)+[a-z]{2,6}$/" required><br/>
				<div ng-show="treasurerLoginform.email.$touched && treasurerLoginform.email.$error.required">
 				...
 				<div ng-show="treasurerLoginform.email.$error.minlength">
 				...
 				<div ng-show="treasurerLoginform.email.$error.maxlength">
 				...
 				<div ng-show="treasurerLoginform.email.$error.pattern">
			...
			<input type="password" name="password" class="input_sekretaris" placeholder="Password" ng-model="password" ng-minlength="5" ng-maxlength="25" ng-pattern="/^[a-zA-Z-0-9]*$/" required><br/>
				<div ng-show="treasurerLoginform.password.$touched && treasurerLoginform.password.$error.required">
 				...
 				<div ng-show="treasurerLoginform.password.$error.minlength">
 				...
 				<div ng-show="treasurerLoginform.password.$error.maxlength">
 				...
 				<div ng-show="treasurerLoginform.password.$error.pattern">
			...
			<div ng-if="treasurerLoginform.$valid">
 				<button type="submit" class="submit" ng-click="trsLogin()">Masuk</button>
 			</div>
 			<div ng-if="!treasurerLoginform.$valid">
 		...
 		<br/>
 		<a class="link" style="text-align: center !important;float: none !important;" href="<?=$Variable['URL'];?>treasurer/forgot_password/">Lupa Katasandi ?</a>
 		<br/>
