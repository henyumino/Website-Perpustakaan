<body ng-app="treasurerForgotPasswordApp" ng-controller="treasurerForgotPasswordController">
  <center>
    <div class="box-forgot">
      <div class="forgot-pass">
        ...
        <p>Masukkan email akun anda maka sistem akan mengirimkan tautan agar anda bisa mengatur ulang katasandi.</p>
         <form method="POST" name="treasurerForgotPasswordForm">
          <input placeholder="Email" style="margin-top: -20px !important;padding: 8px;" class="field-forgot" type="text" name="email" ng-model="email" ng-minlength="15" ng-maxlength="50" ng-pattern="/^([a-z0-9\+_\-]+)(\.[a-z0-9\+_\-]+)*@([a-z0-9\-]+\.)+[a-z]{2,6}$/" required>
           <div ng-show="treasurerForgotPasswordForm.email.$touched && treasurerForgotPasswordForm.email.$error.required">
           ...
           <div ng-show="treasurerForgotPasswordForm.email.$error.minlength">
           ...
           <div ng-show="treasurerForgotPasswordForm.email.$error.maxlength">
           ...
           <div ng-show="treasurerForgotPasswordForm.email.$error.pattern">
           ...
           <div ng-if="treasurerForgotPasswordForm.$valid">
            <button type="submit" ng-click="treasurerForgotPassword()">Konfirmasi</button>
           </div>
           <div ng-if="!treasurerForgotPasswordForm.$valid">
