...
<body ng-app="usersbookDetailApp" ng-controller="usersbookDetailController">
  ...
  <div id="pinjam-buku-dash" style="background: #ffffff;margin-top: -20px;">
    ...
    <div class="pinjam-di">
      <?php 
             if ($Variable['Data']['Jumlah_Buku'] > 0) 
             {               
                ?>
                  <button type="submit" ng-click="borrowBook()">PINJAM</button>
                <?php
             }
             else
             {
               ?>
                 <button type="submit" ng-click="errorborrowBook()">PINJAM</button>
               <?php
             }
      ?>
    </ng-form>
