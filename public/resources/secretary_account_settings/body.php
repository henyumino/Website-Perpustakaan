<body ng-app="secretaryAccountSettingsApp" ng-controller="secretaryAccountSettingsController">
  <div class="menu-atas">
  ...
  <label>Profil</label>
    <hr class="garis-dash">
        <div class="box-input-set">
           <ng-form method="POST" name="secretaryEditAccountForm">
                ...
                <div ng-show="secretaryEditAccountForm.fullname.$touched && secretaryEditAccountForm.fullname.$error.required">
                ...
                <div ng-show="secretaryEditAccountForm.fullname.$error.minlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Nama lengkap minimal 3 karakter
                  </font>
                </div>
                <div ng-show="secretaryEditAccountForm.fullname.$error.maxlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Nama lengkap maksimal 25 karakter
                  </font>
               </div>
               <div ng-show="secretaryEditAccountForm.fullname.$error.pattern">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
               ...
               <select name="dateofbirth" data-ng-model="dateofbirth" required style="margin: 10px 30px 0;width:310px;height:35px;border-radius:5px;border: 1px solid grey;">
                ...
                <div ng-show="secretaryEditAccountForm.dateofbirth.$touched && secretaryEditAccountForm.dateofbirth.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
               ...
               <select name="monthofbirth" data-ng-model="monthofbirth" required style="margin: 10px 46px 0;width:310px;height:35px;border-radius:5px;border: 1px solid grey;">
                ...
                <div ng-show="secretaryEditAccountForm.monthofbirth.$touched && secretaryEditAccountForm.monthofbirth.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
               ...
               <select name="yearofbirth" data-ng-model="yearofbirth" required style="margin: 10px 58px 0;width:310px;height:35px;border-radius:5px;border: 1px solid grey;">
                ...
                <div ng-show="secretaryEditAccountForm.yearofbirth.$touched && secretaryEditAccountForm.yearofbirth.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                ...
                <div ng-show="secretaryEditAccountForm.address.$touched && secretaryEditAccountForm.address.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                      Alamat masih kosong
                  </font>
                </div>
                <div ng-show="secretaryEditAccountForm.address.$error.minlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Alamat minimal 10 karakter
                  </font>
                </div>
                <div ng-show="secretaryEditAccountForm.address.$error.maxlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Alamat maksimal 50 karakter
                  </font>
               </div>
               <div ng-show="secretaryEditAccountForm.address.$error.pattern">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
               ...
               <span class="label-input">Nomor Ponsel</span>
                ...
                <div ng-show="secretaryEditAccountForm.phonenumber.$touched && secretaryEditAccountForm.phonenumber.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                      Nomor ponsel masih kosong
                  </font>
                </div>
                <div ng-show="secretaryEditAccountForm.phonenumber.$error.minlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Nomor ponsel harus terdiri dari 12 digit
                  </font>
                </div>
                <div ng-show="secretaryEditAccountForm.phonenumber.$error.maxlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Nomor ponsel harus terdiri dari 12 digit
                  </font>
               </div>
               <div ng-show="secretaryEditAccountForm.phonenumber.$error.pattern">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
               ...
               <span class="label-input">Email</span>
                ...
                <div ng-show="secretaryEditAccountForm.email.$touched && secretaryEditAccountForm.email.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                      Email masih kosong
                  </font>
                </div>
                <div ng-show="secretaryEditAccountForm.email.$error.minlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Email minimal 15 karakter
                  </font>
                </div>
                <div ng-show="secretaryEditAccountForm.email.$error.maxlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Email maksimal 50 karakter
                  </font>
               </div>
               <div ng-show="secretaryEditAccountForm.email.$error.pattern">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
               ...
               <div ng-show="!profilepicture">
                  <img src="<?=$Variable['URL'].'resources/assets/'.$Variable['Data']['Folder_Sekretaris'].'/'.$Variable['Data']['Foto_Sekretaris'];?>" style="width:180px;height:180px;margin:10px 0px 0px 310px">
              </div>
              <div ng-show="profilepicture">
            ...
            <div ng-show="profilepicture">
              <div class="crop-area-1a">
               ...
               <div ng-if="secretaryEditAccountForm.$valid">
               <button id="button-save-setting" type="submit" ng-click="secretaryEditAccount(croppedprofilepicture, profilepicture.name)">Perbaharui</button>
               </div>
               <div ng-if="!secretaryEditAccountForm.$valid">
          ...
          <div style="margin-top: 30px;">
            ...
            <span class="label-input">Katasandi Lama</span>
             <ng-form method="POST" name="secretaryChangePasswordForm">
                ...
                <div ng-show="secretaryChangePasswordForm.password.$touched && secretaryChangePasswordForm.password.$error.required">
                ...
                <div ng-show="secretaryChangePasswordForm.password.$error.minlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
                     Katasandi lama minimal 5 karakter
                  </font>
                </div>
                <div ng-show="secretaryChangePasswordForm.password.$error.maxlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
                     Katasandi lama maksimal 25 karakter
                  </font>
               </div>
               <div ng-show="secretaryChangePasswordForm.password.$error.pattern">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
               ...
               <input type="password" name="newpassword" ng-model="newpassword" ng-minlength="5" ng-maxlength="25" ng-pattern="/^[a-zA-Z-0-9]*$/" required style="margin: 10px 37px 0;width:295px;padding:8px;border-radius:5px;border: 1px solid grey;">
                <div ng-show="secretaryChangePasswordForm.newpassword.$touched && secretaryChangePasswordForm.newpassword.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
                      Katasandi baru masih kosong
                  </font>
                </div>
                <div ng-show="secretaryChangePasswordForm.newpassword.$error.minlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
                     Katasandi baru minimal 5 karakter
                  </font>
                </div>
                <div ng-show="secretaryChangePasswordForm.newpassword.$error.maxlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
                     Katasandi baru maksimal 25 karakter
                  </font>
               </div>
               <div ng-show="secretaryChangePasswordForm.newpassword.$error.pattern">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
                     Katasandi baru hanya boleh berisi huruf dan angka
                  </font>
               </div>
               <div ng-if="secretaryChangePasswordForm.$valid">
               <button id="button-update-pass" type="submit" ng-click="secretaryChangePassword()">Ganti Katasandi</button>
               </div>
               <div ng-if="!secretaryChangePasswordForm.$valid">
