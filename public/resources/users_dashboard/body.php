...
<body ng-app="usersDashboardApp" ng-controller="usersDashboardController">
  <div class="side-menu">
  ...
  <div class="main-dash" id="buku">
    ...
    <span class="ket-dash">Dashboard / Buku</span>
    <hr class="garis-dash">
	...
	<?php
			...
			{
				for ($i=1; $i <= count($Variable['Buku']); $i++) 
          		{
          			?>
          			<div class="book-wh">
          				<img src="<?=$Variable['URL'].'resources/assets/'.$Variable['Buku'][$i]['Folder_Buku'].'/'.$Variable['Buku'][$i]['Foto_Buku'];?>"/>
          				<div class="button-pinjam">
          					<a href="<?=$Variable['URL'].'dashboard/book.php?id='.$Variable['Buku'][$i]['ID_Buku'];?>"><span>PINJAM</span></a>
          				</div>
          			</div>
          			<?php
          		}
   ...
   <div class="pagging">
    <?php
              ...
              {
                ?> <a href="<?=$Variable['URL'].'dashboard/index.php?page='.($Variable['Halaman_Paging']+1);?>" style="color: blue;">Selanjutnya</a> <?php
              }
              else
              {
              ...
              {
                 ?> <a href="<?=$Variable['URL'].'dashboard/index.php?page='.($Variable['Halaman_Paging']-1);?>" style="color: blue;">Sebelumnya</a> <?php
              } 
      ?>
      </div>
