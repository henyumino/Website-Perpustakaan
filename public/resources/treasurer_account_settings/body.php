<body ng-app="treasurerAccountSettingsApp" ng-controller="treasurerAccountSettingsController">
  <div class="menu-atas">
  ...
  <label>Profil</label>
    <hr class="garis-dash">
        <div class="box-input-set">
           <ng-form method="POST" name="treasurerEditAccountForm">
                ...
                <div ng-show="treasurerEditAccountForm.fullname.$touched && treasurerEditAccountForm.fullname.$error.required">
                ...
                <div ng-show="treasurerEditAccountForm.fullname.$error.minlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Nama lengkap minimal 3 karakter
                  </font>
                </div>
                <div ng-show="treasurerEditAccountForm.fullname.$error.maxlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Nama lengkap maksimal 25 karakter
                  </font>
               </div>
               <div ng-show="treasurerEditAccountForm.fullname.$error.pattern">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
               ...
               <select name="dateofbirth" data-ng-model="dateofbirth" required style="margin: 10px 30px 0;width:310px;height:35px;border-radius:5px;border: 1px solid grey;">
                ...
                <div ng-show="treasurerEditAccountForm.dateofbirth.$touched && treasurerEditAccountForm.dateofbirth.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
               ...
               <select name="monthofbirth" data-ng-model="monthofbirth" required style="margin: 10px 46px 0;width:310px;height:35px;border-radius:5px;border: 1px solid grey;">
                ...
                <div ng-show="treasurerEditAccountForm.monthofbirth.$touched && treasurerEditAccountForm.monthofbirth.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
               ...
               <select name="yearofbirth" data-ng-model="yearofbirth" required style="margin: 10px 58px 0;width:310px;height:35px;border-radius:5px;border: 1px solid grey;">
                ...
                <div ng-show="treasurerEditAccountForm.yearofbirth.$touched && treasurerEditAccountForm.yearofbirth.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                ...
                <div ng-show="treasurerEditAccountForm.address.$touched && treasurerEditAccountForm.address.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                      Alamat masih kosong
                  </font>
                </div>
                <div ng-show="treasurerEditAccountForm.address.$error.minlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Alamat minimal 10 karakter
                  </font>
                </div>
                <div ng-show="treasurerEditAccountForm.address.$error.maxlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Alamat maksimal 50 karakter
                  </font>
               </div>
               <div ng-show="treasurerEditAccountForm.address.$error.pattern">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
               ...
               <span class="label-input">Nomor Ponsel</span>
                ...
                <div ng-show="treasurerEditAccountForm.phonenumber.$touched && treasurerEditAccountForm.phonenumber.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                      Nomor ponsel masih kosong
                  </font>
                </div>
                <div ng-show="treasurerEditAccountForm.phonenumber.$error.minlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Nomor ponsel harus terdiri dari 12 digit
                  </font>
                </div>
                <div ng-show="treasurerEditAccountForm.phonenumber.$error.maxlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Nomor ponsel harus terdiri dari 12 digit
                  </font>
               </div>
               <div ng-show="treasurerEditAccountForm.phonenumber.$error.pattern">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
               ...
               <span class="label-input">Email</span>
                ...
                <div ng-show="treasurerEditAccountForm.email.$touched && treasurerEditAccountForm.email.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                      Email masih kosong
                  </font>
                </div>
                <div ng-show="treasurerEditAccountForm.email.$error.minlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Email minimal 15 karakter
                  </font>
                </div>
                <div ng-show="treasurerEditAccountForm.email.$error.maxlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
                     Email maksimal 50 karakter
                  </font>
               </div>
               <div ng-show="treasurerEditAccountForm.email.$error.pattern">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:300px;margin:10px;position:relative;">
               ...
               <div ng-show="!profilepicture">
                  <img src="<?=$Variable['URL'].'resources/assets/'.$Variable['Data']['Folder_Bendahara'].'/'.$Variable['Data']['Foto_Bendahara'];?>" style="width:180px;height:180px;margin:10px 0px 0px 310px">
              </div>
              <div ng-show="profilepicture">
            ...
            <div ng-show="profilepicture">
              <div class="crop-area-1a">
               ...
               <div ng-if="treasurerEditAccountForm.$valid">
               <button id="button-save-setting" type="submit" ng-click="treasurerEditAccount(croppedprofilepicture, profilepicture.name)">Perbaharui</button>
               </div>
               <div ng-if="!treasurerEditAccountForm.$valid">
          ...
          <div style="margin-top: 30px;">
            ...
            <span class="label-input">Katasandi Lama</span>
             <ng-form method="POST" name="treasurerChangePasswordForm">
                ...
                <div ng-show="treasurerChangePasswordForm.password.$touched && treasurerChangePasswordForm.password.$error.required">
                ...
                <div ng-show="treasurerChangePasswordForm.password.$error.minlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
                     Katasandi lama minimal 5 karakter
                  </font>
                </div>
                <div ng-show="treasurerChangePasswordForm.password.$error.maxlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
                     Katasandi lama maksimal 25 karakter
                  </font>
               </div>
               <div ng-show="treasurerChangePasswordForm.password.$error.pattern">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
               ...
               <input type="password" name="newpassword" ng-model="newpassword" ng-minlength="5" ng-maxlength="25" ng-pattern="/^[a-zA-Z-0-9]*$/" required style="margin: 10px 37px 0;width:295px;padding:8px;border-radius:5px;border: 1px solid grey;">
                <div ng-show="treasurerChangePasswordForm.newpassword.$touched && treasurerChangePasswordForm.newpassword.$error.required">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
                      Katasandi baru masih kosong
                  </font>
                </div>
                <div ng-show="treasurerChangePasswordForm.newpassword.$error.minlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
                     Katasandi baru minimal 5 karakter
                  </font>
                </div>
                <div ng-show="treasurerChangePasswordForm.newpassword.$error.maxlength">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
                     Katasandi baru maksimal 25 karakter
                  </font>
               </div>
               <div ng-show="treasurerChangePasswordForm.newpassword.$error.pattern">
                  <font style="color:red;display:inline-block;color:red;width:100%;top:5px;bottom:5px;left:310px;margin:10px;position:relative;">
                     Katasandi baru hanya boleh berisi huruf dan angka
                  </font>
               </div>
               <div ng-if="treasurerChangePasswordForm.$valid">
               <button id="button-update-pass" type="submit" ng-click="treasurerChangePassword()">Ganti Katasandi</button>
               </div>
               <div ng-if="!treasurerChangePasswordForm.$valid">
